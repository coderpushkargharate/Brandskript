...
const caseDetailsData = [
  {
    id: 1,
    title: "How Namami Inc. Is Using ShortVids As Their Extended Creative Partner",
...
exceptional storytelling.
  ...
  {
    id: 3,
    title: "How Cody Blundell Grows His Personal Brand & PARAFLIX with ShortVids",
    date: "21 June 2025",
...
const CaseDetailshome = () => {
  const { id } = useParams();
  const caseItem = caseDetailsData.find((b) => b.id === parseInt(id));
  ...
  return (
    <section className="min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-20">
...
export default CaseDetailshome;
