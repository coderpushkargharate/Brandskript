  ...
  return (
    <div className="bg-white text-gray-900 font-sans">
      ...
      <section className="text-center py-20 px-6 bg-gray-50">
        <h1 className="text-4xl md:text-6xl font-bold">
          Lead Generation <span className="text-blue-600">Services</span>
        </h1>
        ...
        <div className="mt-8 flex items-center justify-center gap-2">
          ...
          <p className="ml-2 text-gray-600">4.9/5 from 700+ Customers</p>
        </div>
      ...
      <section className="max-w-5xl mx-auto py-16 px-6">
        <div className="bg-gray-100 rounded-2xl overflow-hidden shadow-xl">
          <div className="relative">
            ...
            <button className="absolute inset-0 flex items-center justify-center">
              <span className="bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 transition">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          {[
            ...
            <div
              key={i}
              className="p-6 bg-gray-50 rounded-xl text-center border hover:shadow-md transition"
            >
    ...
    color: "var(--h2-color)"
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {["Research", "Plan", "Build", "Launch"].map((step, i) => (
            <div
              key={i}
              className="p-6 bg-gray-50 rounded-xl border hover:shadow-md transition"
            >
              <h3 className="font-semibold text-lg text-blue-700">{step}</h3>
    ...
    color: "var(--h2-color)"
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div
              ...
              className="p-6 bg-gray-50 rounded-xl border hover:shadow-md transition"
            >
              <h3 className="font-semibold text-lg text-blue-700">{service}</h3>
              <p className="mt-2 text-gray-600">
      ...
      <section className="text-center py-16 bg-gray-50">
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div>
            <h3 className="text-4xl font-bold text-blue-700">175+</h3>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="mt-4 font-semibold text-blue-700">– Successful Client</p>
      </section>
    ...
    color: "var(--h2-color)"
        ...
        <div className="space-y-4">
          {[
            ...
            <div
              key={i}
              className="p-4 bg-gray-100 rounded-lg flex items-center justify-between cursor-pointer hover:bg-gray-200 transition"
            >
              <span>{q}</span>
