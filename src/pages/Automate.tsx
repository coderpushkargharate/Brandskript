    ...
    <div className="bg-white text-black overflow-hidden dm-sans">
      ...
      <section className="rounded-3xl mx-4 lg:mx-24 sm:mx-6 mt-6 px-6 sm:px-10 py-14 bg-[#ECFDF5]">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-center text-2xl sm:text-3xl lg:text-4xl font-bold max-w-3xl mx-auto leading-snug dm-sans">
            Delegate Your Business’s Client {" "} <br />
            <span className="text-[#6bbf00]">Acquisition to ROI Edge</span>
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-lg transition h-full">
              ...
              <h3 className="font-medium mt-5 text-lg noir-pro">
                Reclaim your time
              </h3>
              <p className="text-gray-600 text-sm mt-3 leading-relaxed dm-sans">
      ...
      <section className="mt-24 rounded-3xl mx-6 lg:mx-24 sm:mx-10 lg:mx-16 px-6 sm:px-10 py-20 sm:py-28 bg-[#0074ff]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold leading-snug dm-sans">
            Book a consultation call to discuss <br /> your business goals
          </h2>

          <p className="text-gray-400 mt-6 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed dm-sans">
          ...
          <div className="flex justify-center mt-12">
            <button className="bg-[#d2fe3a] hover:bg-[#c7f230] text-black px-14 py-4 rounded-full font-semibold transition shadow-lg">
              Book An Appointment
            </button>
          </div>
      ...
      <section className="bg-gray-50 rounded-3xl mx-4 sm:mx-6 my-20 lg:mx-24 px-6 sm:px-10 py-14">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          {/* Text */}
          <div>
            <h3 className="text-xl sm:text-2xl font-medium noir-pro">
              Check Our Socials
            </h3>
            <p className="text-gray-600 mt-4 text-sm sm:text-base leading-relaxed max-w-md dm-sans">
              Have questions about ROI Edge or need general business advice?
              Connect directly with the Founder or follow us for insights.
            </p>

            <button className="mt-7 bg-[#d2fe3a] hover:bg-[#c7f230] text-black px-9 py-3 rounded-full font-medium transition">
              Connect With Us
            </button>
          </div>
