  ...
  return (
    <div className="flex justify-center items-center w-full px-4 py-12 bg-teal-50">
      <div className="bg-white w-full max-w-3xl p-6 md:p-10 rounded-2xl shadow-lg">
        ...
        {/* Submit Button */}
        <button className="w-full bg-green-500 text-white font-semibold py-3 rounded-xl mt-6 hover:bg-orange-600">
          Book Session
        </button>
      </div>
    </div>
...
export default StartOnEstimate;
