...
export default function Healthcare() {
  ...
  return (
    <div className="bg-[#f8f8f8] min-h-screen pb-20 px-4 md:px-10 dm-sans">
      ...
      <section className="w-full bg-white py-14 px-6 lg:px-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          <div className="bg-blue-600 rounded-3xl p-10 text-white">
            ...
            <p className="text-sm mt-2 opacity-80 mt-4">7-day free trial</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <img key={i} className="rounded-xl w-full h-auto object-cover" src={src} alt={`Healthcare image ${i + 1}`} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="bg-blue-50 py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl font-bold text-green-600 mb-4">We attract the right patients — not just more enquiries</h2>
            <p className="mb-4 text-gray-700">
              More enquiries don't mean more revenue if they're unqualified.
            </p>
            <p className="mb-4 text-gray-700">We build systems that:</p>
      ...
      <section className="bg-blue-50 py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-green-600 mb-4">We align acquisition with how healthcare decisions are made</h2>
            <p className="mb-4 text-gray-700">
      ...
      <section className="py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-green-600 mb-4">We track what actually drives revenue</h2>
      ...
      <section className="bg-blue-50 py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl font-bold text-green-600 mb-4">We automate what overwhelms your team</h2>
      ...
      <section className="py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-green-600 mb-4">Built for predictable, sustainable patient flow</h2>
          ...
          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 p-4 rounded-lg">
            <h3 className="text-2xl font-bold text-green-600 mb-2">Growth that's sustainable, ethical, and profitable.</h3>
            <p className="text-gray-700">
      ...
      <section className="bg-blue-50 py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="mb-6 text-gray-700">This is for healthcare businesses that:</p>
      ...
      <section className="py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl shadow-lg p-8">
            <h2 className="text-3xl font-bold text-green-600 mb-4">Build a profitable Client Acquisition System for your Healthcare Business</h2>
