  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-white to-gray-50 text-center py-16 md:py-24 text-gray-900 relative overflow-hidden">
        ...
        {/* Subtle Glow Effect */}
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-[500px] sm:w-[600px] h-[500px] sm:h-[600px] bg-indigo-200 opacity-30 blur-[150px] rounded-full"></div>
      </section>
              ...
              {testimonials.map((client, index) => (
                ...
                >
                  <div className="relative rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
                    ...
                    {/* Glass Prism Text Overlay */}
                    <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-5">
                      <div className="backdrop-blur-md bg-white/30 border border-white/40 rounded-xl p-3 sm:p-4 shadow-lg">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
                      <button className="w-12 sm:w-14 h-12 sm:h-14 bg-indigo-600 text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300">
                        <svg
